...
public:
	...
	buffer_reference input_buffer{ this,										  //Constructor of buffer reference before input_buffer_name attribute
		[this](const c74::min::atoms& args, const int inlet) -> c74::min::atoms { // will receive a symbol arg indicating 'binding', 'unbinding', or 'modified'
	...
	message<> dspsetup{
		this, "dspsetup", [this](const c74::min::atoms& args, const int inlet) -> c74::min::atoms {
			sampleRate = static_cast<float>(args[0]);
			multiFrameOsc.osc.setSampleRate(sampleRate);
			multiFrameOsc.osc1.setSampleRate(sampleRate);
	...
	message<> add_frame{
		this, "add_frame", "Read from input buffer", [this](const c74::min::atoms& args, const int inlet) -> c74::min::atoms {
			//Read from buffer
	...
	message<> flip_phase{
		this, "flip_phase", [this](const c74::min::atoms& args, const int inlet) -> c74::min::atoms {
	...
	message<> move_up_selected_frame{
		this, "move_up_selected_frame", [this](const c74::min::atoms& args, const int inlet) -> c74::min::atoms {
	...
	message<> move_down_selected_frame{
		this, "move_down_selected_frame", [this](const c74::min::atoms& args, const int inlet) -> c74::min::atoms {
	...
	message<> delete_selected_frame{
		this, "delete_selected_frame", [this](const c74::min::atoms& args, const int inlet) -> c74::min::atoms {
	...
	message<> clear_all{
		this, "clear_all", [this](const c74::min::atoms& args, const int inlet) -> c74::min::atoms {
	...
	message<> morph_position{
		this, "morph_position", [this](const c74::min::atoms& args, const int inlet) -> c74::min::atoms {
	...
	message<> set_freq{
		this, "set_freq", [this](const c74::min::atoms& args, const int inlet) -> c74::min::atoms {
			...
			multiFrameOsc.osc1.setFrequency(oscillatorFreq);
			return {};
		}
	};

	message<> set_output_gain{
		this, "set_output_gain", [this](const c74::min::atoms& args, const int inlet) -> c74::min::atoms {
	...
	message<> set_export_tablesize{
		this, "set_export_tablesize", [this](const c74::min::atoms& args, const int inlet) -> c74::min::atoms {
	...
	message<> export_table{
		this, "export_table", [this](const c74::min::atoms& args, const int inlet) -> c74::min::atoms {
